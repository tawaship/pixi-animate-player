...
lib.ssMetadata = [
		{name:"game_atlas_", frames: [[0,0,32,32]]}
];
...
(lib.game = function(mode,startPosition,loop) {
	...
	this.shape_30.graphics.beginFill("#6E6E6E").beginStroke().moveTo(2.8,6).lineTo(2.8,5.6).curveTo(3.7,5.4,3.8,4.9).curveTo(4,4.6,4,3.5).lineTo(4,-1.5).curveTo(3.9,-3,3.7,-3.6).curveTo(3.4,-4.6,2.6,-4.5).curveTo(1.6,-4.5,0.8,-2.7).lineTo(0.8,3.3).curveTo(0.8,4.7,1,5.2).curveTo(1.2,5.5,1.8,5.6).lineTo(1.8,6).lineTo(-1.6,6).lineTo(-1.6,5.6).curveTo(-1,5.5,-0.8,5.2).curveTo(-0.5,4.8,-0.5,3.5).lineTo(-0.5,-1.7).curveTo(-0.5,-4.5,-1.9,-4.5).curveTo(-3,-4.5,-3.7,-2.7).lineTo(-3.7,4).curveTo(-3.7,5.5,-2.7,5.6).lineTo(-2.7,6).lineTo(-6,6).lineTo(-6,5.6).curveTo(-5.3,5.5,-5,4.9).lineTo(-4.9,3.5).lineTo(-4.9,-2.6).curveTo(-4.9,-4.4,-5.5,-4.5).lineTo(-5.9,-4.4).lineTo(-5.9,-4.8).curveTo(-4.5,-5.4,-3.8,-5.9).lineTo(-3.8,-5.9).lineTo(-3.8,-3.8).curveTo(-3.5,-4.8,-2.8,-5.4).curveTo(-2,-6,-1.3,-6).curveTo(0.1,-6,0.5,-3.6).curveTo(0.9,-4.5,1.5,-5.2).curveTo(2.3,-6,3.2,-6).curveTo(5.2,-6,5.3,-1.5).lineTo(5.3,3.7).lineTo(5.3,4.9).curveTo(5.5,5.5,6,5.6).lineTo(6,6).closePath();
