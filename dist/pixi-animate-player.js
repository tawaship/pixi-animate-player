...
this.PIXI = this.PIXI || {}, function(exports, _PIXI) {
    ...
    }(_PIXI.Container), PixiSprite = function(Sprite) {
    ...
    }(_PIXI.Sprite), PixiShape = function(Container) {
    ...
    }(_PIXI.Container), PixiGraphics = function(Graphics) {
    ...
    }(_PIXI.Graphics), PixiTextContainer = function(Container) {
    ...
    }(_PIXI.Container), PixiButtonHelper = function(Container) {
    ...
    }(_PIXI.Container), createjsOrigin = {
                    ...
                    if (value) {
                        for (var list = [], i = 0; i < value.length; i++) {
                            ...
                            if (!(f instanceof createjs.ColorMatrixFilter)) {
                                var m = new _PIXI.filters.ColorMatrixFilter;
                        ...
                        for (var o = this._pixiData.instance, c = o.children, n = new _PIXI.Container, nc = this._pixiData.subInstance = n.addChild(new _PIXI.Container); c.length; ) {
                            nc.addChild(c[0]);
                        }
    ...
    var LineCap = {
        0: _PIXI.LINE_JOIN.BUTT,
        1: _PIXI.LINE_JOIN.ROUND,
        2: _PIXI.LINE_JOIN.SQUARE
    }, LineJoin = {
    ...
    Object.defineProperties(createjs.Graphics.prototype, {
        ...
        function Text$1(text, font, color) {
            var _font = this._parseFont(font), t = new _PIXI.Text(text, {
    ...
    var PIXI, prepareAnimateAsync$1 = function(id, basepath) {
    ...
    !function(PIXI) {
        !function(animate) {
            var Player = function(id, rootName, basepath, pixiOptions) {
                ...
                })), document.body.appendChild(this._app.view), this._app.stop(), this._id = id, 
    ...
    var Player = PIXI.animate.Player;
